...
CDEFS += -DSPI_PORT=PORTB
CDEFS += -DSPI_DDR=DDRB
CDEFS += -DSPI_MOSI=PB3
CDEFS += -DSPI_MISO=PB4
CDEFS += -DSPI_SCK=PB5
CDEFS += -DSR_CE_PIN=PD6
CDEFS += -DSR_PL_PIN=PD7
CDEFS += -DSR_PL_CE_PORT=PORTD
CDEFS += -DSR_PL_CE_DDR=DDRD
CDEFS += -DDAC_PORT=PORTB
CDEFS += -DDAC_DDR=DDRB
CDEFS += -DDAC_LDAC_PIN=PB0
CDEFS += -DDAC_CLR_PIN=PB1
CDEFS += -DDAC_CS_PIN=PB2
